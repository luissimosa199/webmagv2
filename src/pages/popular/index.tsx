...
const Popular: FunctionComponent<PopularPageProps> = ({ postData }) => {
  return (
    <div className="min-h-screen">
      <h1 className="capitalize text-2xl font-semibold ml-28 my-2">Popular</h1>
...
export const getServerSideProps: GetServerSideProps<PopularPageProps> = async (context: GetServerSidePropsContext) => {
  try {
    await dbConnect();
